...
| [Анализ поведения пользователей в мобильном приложении по продаже продуктов питания](https://github.com/ZharikhinaAlena/yandex_practicum_da/blob/main/aab_test/ab_mobile_app%20.ipynb) | В данном проекте была исследована воронка продаж и проанализированы результаты A/A/B-тестирования в мобильном приложении по продаже продуктов питания. Выявлено на каком этапе теряется большее количество пользователей, даны рекомендации по усовершенствованию приложения. 
В ходе проверки A/B теста сделан  вывод, что изменение шрифта в приложении не повлияло на поведение пользователей. | Python, Pandas, Matplotlib, Numpy, Seaborn, Scipy, Math, визуализация данных, проверка статистических гипотез, событийная аналитика, A/А/B-тесты. |
